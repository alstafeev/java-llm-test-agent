...
/**
 * Integration tests for UiTestGeneratorAgent using EmbabelMockitoIntegrationTest. Tests the complete workflow under
 * Spring Boot with mocked LLM responses. Follows example-agent's WriteAndReviewAgentIntegrationTest pattern.
 */
