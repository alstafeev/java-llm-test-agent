...
/**
 * An autonomous agent that generates and repairs Playwright UI tests.
 * Uses DOM snapshots to understand the page and handles errors by repairing the
 * source code.
 */
@Slf4j
...
public class UiTestGeneratorAgent {
    ...
    /**
     * Analyzes the test case requirements and page DOM to generate a complete JUnit
     * 5 Playwright test.
     */
    ...
    /**
     * Runs the provided test code and repairs it if it fails, achieving the goal of
     * a passing test.
     */
    @AchievesGoal(description = "The test passes successfully", export = @Export(remote = true, name = "generateAndRunUiTest"))
