...
abstract class Personas {
  ...
  /**
   * Persona for step-by-step analysis - analyzes DOM and screenshots to produce exact Playwright instructions.
   */
  ...
  /**
   * Persona for final code generation - transforms executed steps into clean Java test code.
   */
