...
/**
 * Service for GitHub API operations. Handles Pull Request creation and reviewer assignment.
 * <p>
...
public class GitHubService {
  ...
  /**
   * Extracts owner and repo from a Git URL. Supports SSH and HTTPS formats.
   */
